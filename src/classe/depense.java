...
//        Connection c = (Connection) connexionbd.seconnecter();
//        PreparedStatement ps = (PreparedStatement) c.prepareStatement(
//            "INSERT INTO depense (motif, montant, date_depense) VALUES (?, ?, ?)"
//        );
//        ps.setString(1, motif);
//        ps.setDouble(2, montant);
//        ps.setString(3, date);
...
//        Connection c = (Connection) connexionbd.seconnecter();
//        Statement st = (Statement) c.createStatement();
//        ResultSet rs = st.executeQuery("SELECT SUM(montant) FROM depense");
//        if (rs.next()) {
//            total = rs.getDouble(1);
//        }
//        rs.close();
...
//        Connection c = (Connection) connexionbd.seconnecter();
//        Statement st = (Statement) c.createStatement();
//        return st.executeQuery("SELECT motif, montant, date_depense FROM depense ORDER BY date_depense DESC LIMIT 20");
//    }
//// Récupérer les dépenses archivées
//public static ResultSet getDepensesArchive() throws SQLException, ClassNotFoundException {
//    Connection c = (Connection) connexionbd.seconnecter();
//    Statement st = (Statement) c.createStatement();
//    return st.executeQuery("SELECT motif, montant, date_depense, id_caisse, date_archive FROM depense_archive ORDER BY date_archive DESC LIMIT 50");
//}
//public static void mettreAJourCaisse(String idCaisse) throws SQLException, ClassNotFoundException {
//    Connection c = (Connection) connexionbd.seconnecter();
//
