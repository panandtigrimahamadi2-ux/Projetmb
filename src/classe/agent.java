...
//    public static void mettreAJourBouteilles(String nom, int nbBouteilles) {
//        try {
//            Connection c = connexionbd.seconnecter();
//            String sql = "UPDATE agent SET nb_bouteilles = ? WHERE nom = ?";
//            PreparedStatement ps = c.prepareStatement(sql);
//            ps.setInt(1, nbBouteilles);
//            ps.setString(2, nom);
//            ps.executeUpdate();
...
//package classe;
//
//import static classe.profil.rs;
//import java.sql.*;
//import java.util.Vector;
//import java.util.logging.Level;
//import java.util.logging.Logger;
...
//        try {
//            Connection c = connexionbd.seconnecter();
//            String sql = "INSERT INTO agent (nom, date_naissance, profil, type_salaire, salaire, prix_par_bouteille) " +
//                         "VALUES (?, ?, ?, ?, ?, ?)";
//            PreparedStatement ps = c.prepareStatement(sql);
//            ps.setString(1, nom);
//            ps.setDate(2, dateNaissance);
...
//            }
//
//            // ⚡ Utilisation sécurisée pour la date
//            String dateStr = rs.getString("date_naissance");
//            Object dateAffiche = null;
//            if (dateStr != null && !dateStr.equals("0000-00-00")) {
//                try {
//                    dateAffiche = java.sql.Date.valueOf(dateStr);
//                } catch (Exception ex) {
//                    dateAffiche = null; // ou "N/A"
//                }
//            }
//
//            Vector<Object> ligne = new Vector<>();
//            ligne.add(rs.getString("nom"));
//            ligne.add(dateAffiche); // ⚡ plus sûr que rs.getDate()
//            ligne.add(rs.getString("profil"));
//            ligne.add(safeDate(rs, "date_naissance"));
//            ligne.add(type);
//            ligne.add(nbBouteillesAffiche);
//            ligne.add(salaireBrut);
//
...
////        Connection c = connexionbd.seconnecter();
////        Statement st = c.createStatement();
////        ResultSet rs = st.executeQuery("SELECT nom, date_naissance, profil, type_salaire, salaire, prix_par_bouteille, nb_bouteilles FROM agent");
////
////        while (rs.next()) {
////            String type = rs.getString("type_salaire");
////            double salaireBrut;
...
////            Vector<Object> ligne = new Vector<>();
////            ligne.add(rs.getString("nom"));
////            ligne.add(rs.getDate("date_naissance"));
////            ligne.add(rs.getString("profil"));
////            ligne.add(type);
////            ligne.add(nbBouteillesAffiche);
////            ligne.add(salaireBrut);
